  ...
  Header &&
    (Header.innerHTML = `
      <div class="flex flex-col gap-[20px] w-full h-full ">
        <div class="more flex items-center justify-between gap-[20px] bg-[#f5f5f5] dark:bg-[#2B2B2B] duration-300 rounded-[25px] py-2.5 px-6 w-full">
          <ul class="flex items-center gap-[35px] text-[#333] dark:text-[#959595] text-[14px] leading-[19px]">
            ${navItems}
          </ul>
          <div id="themeBtn" class="relative w-[54px] h-[30px] bg-[#333] dark:bg-black duration-300 rounded-full flex items-center justify-between px-2 cursor-pointer">
            ...
            <div class="circle absolute w-[22px] h-[22px] bg-white rounded-full left-[4px] duration-300 top-[50%] translate-y-[-50%] z-20"></div>
          </div>
        </div>
        ...
        <nav class="grid grid-cols-12 w-full items-center gap-[15px]">
          <div class="col-span-10 flex items-center gap-[15px]">
            ...
            <div class="search flex items-center bg-[#f5f5f5] dark:bg-[#2B2B2B] duration-300 rounded-[12px] h-[50px] w-[80%] pr-[22px]">
              <input type="text" placeholder="Məhsul axtar..." class="text-[#333] dark:text-gray-200 font-bold w-full pl-[22px] text-[14px] outline-none border-none"/>
              <i class="ri-search-line dark:text-gray-400 duration-300 text-2xl"></i>
            </div>
          </div>
          <div class="col-span-2">
         <ul class="flex items-center justify-between gap-[8px]">
              <li
                class="w-[50px] h-[50px] bg-[#f5f5f5] dark:bg-[#2B2B2B] dark:text-white text-[#333] leading-[50px] rounded-[12px] cursor-pointer hover:bg-[#dadada] duration-300 dark:hover:bg-[#3d3d3d] flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="26"
